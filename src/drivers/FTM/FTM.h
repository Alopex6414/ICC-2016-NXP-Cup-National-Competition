...
#define FTM_PRECISON 100000u     //定义占空比精度，100即精度为1%，1000u则精度为0.1%，用于占空比 duty 形参传入，即占空比为 duty/FTM_PRECISON
...
/************************正交解码****************************/
extern void FTM_QUAD_init(void);
extern int GetQUAD(void);
